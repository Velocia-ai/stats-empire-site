  ...
  return (
    ...
    >
      ...
      <Reveal className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
        <span className="inline-flex min-h-[44px] items-center gap-2 rounded-full border border-border bg-surface/60 px-4 font-mono text-[0.7rem] uppercase tracking-[0.28em] text-accent1 backdrop-blur sm:text-xs lg:text-sm">
